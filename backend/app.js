...
const REFRESH_TOKEN =
  "1//04GNIPYfVSISFCgYIARAAGAQSNwF-L9IrC2KIcXs1LKVhWnmOL2NLFCeNM6EWHBYfgNw2Tu7N-rK7nxN1fcZ2t_lb-rgtYxVQZW8";
...
app.post("/sellerforget", async function (req, res) {
  ...
  const resetPasswordUrl = `${req.protocol}://${req.get(
    "host"
  )}/sellerpassword/reset${resetToken}`;
...
app.put("/sellerpassword/reset/:token", async function (req, res) {
  // creating token hash
  const resetPasswordtoken = crypto
    .createHash("sha256")
    .update(req.params.token)
